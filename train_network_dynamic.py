...
model.compile(optimizer='adam', loss='binary_crossentropy', metrics=['accuracy','MeanAbsoluteError'], run_eagerly = True)
...
new_model.compile(optimizer='adam', loss='binary_crossentropy', metrics=['accuracy','MeanAbsoluteError'], run_eagerly = True)
